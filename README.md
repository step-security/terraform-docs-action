...
jobs:
  docs:
    ...
    - name: Render terraform docs inside the README.md and push changes back to PR branch
      uses: step-security/terraform-docs-action@v1
      with:
        working-dir: .
...
Complete examples can be found [here](https://github.com/step-security/terraform-docs-action/tree/main/examples).
